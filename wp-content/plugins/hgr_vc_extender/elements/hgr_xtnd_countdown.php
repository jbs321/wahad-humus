		...
		*/
		function hgr_countdown_init() {
			if(function_exists('vc_map')) {
				vc_map(
					array(
					   "name"				=>	__("HGR CountDown", "hgr_lang"),
					   "holder"				=>	"div",
					   "base"				=>	"hgr_countdown",
					   "class"				=>	"",
					   "icon"				=>	"hgr_countdown",
					   "description"		=>	__("Countdown to a given date", "hgr_lang"),
					   ...
					   "params"				=>	array(
							...
							array(
								"type"			=>	"dropdown",
								"class"			=>	"",
								"heading"		=>	__("Counter font tag:", "hgr_lang"),
							...
							array(
								"type"			=>	"colorpicker",
								"class"			=>	"",
								"heading"		=>	__("Counter font color:", "hgr_lang"),
								"param_name"	=>	"counter_font_color",
								"value"			=>	"#222222",
								"description"	=>	__("Pick a color for your counter font.", "hgr_lang"),
								"save_always" 	=>	true,
							),
							array(
								"type"			=>	"dropdown",
								"class"			=>	"",
								"heading"		=>	__("Label font tag:", "hgr_lang"),
							...
							array(
								"type"			=>	"colorpicker",
								"class"			=>	"",
								"heading"		=>	__("Label font color:", "hgr_lang"),
								"param_name"	=>	"label_font_color",
								"value"			=>	"#222222",
								"description"	=>	__("Pick a color for your label font.", "hgr_lang"),
								"save_always" 	=>	true,
							),
							array(
								"type"			=>	"textfield",
							...
							array(
								'type'			=>	'css_editor',
								'heading'		=>	__( 'Css', 'hgr_lang' ),
								'param_name'	=>	'css',
								'group'			=>	__( 'Design options', 'hgr_lang' ),
							),
					   )
					) 
				);
